...
[![hexlet-check](https://github.com/kitte1105/php-project-45/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/kitte1105/php-project-45/actions)
...
```bash
git clone https://github.com/kitte1105/php-project-45.git
cd php-project-45
```

## Использование
Пример работы: https://asciinema.org/a/lpem5FCNGnvXMC3C
